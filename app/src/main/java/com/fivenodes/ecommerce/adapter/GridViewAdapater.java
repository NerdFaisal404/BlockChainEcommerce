...
public class GridViewAdapater extends ArrayAdapter<GridViewItem> {
	Context mContext;
	int resourceId;
	ArrayList<GridViewItem> data = new ArrayList<GridViewItem>();

	public GridViewAdapater(Context context, int layoutResourceId, ArrayList<GridViewItem> data) {
