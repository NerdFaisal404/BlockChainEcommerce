...
import com.fivenodes.ecommerce.adapter.ProfileAdapter;
...
public class ProfileActivity extends FragmentActivity implements
    ...
    private ProfileAdapter tabPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabPagerAdapter = new ProfileAdapter(getSupportFragmentManager());
