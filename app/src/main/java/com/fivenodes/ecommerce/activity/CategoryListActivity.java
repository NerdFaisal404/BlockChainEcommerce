...
import com.fivenodes.ecommerce.adapter.CategoryListAdapter;
...
public class CategoryListActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cla = new CategoryListAdapter(CategoryListActivity.this);

        // category API url
    	CategoryAPI = Constant.CategoryAPI+"?token="+Constant.AccessKey;
		...
		listCategory.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				// go to menu page
				Intent iMenuList = new Intent(CategoryListActivity.this, MenuListActivity.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.cart:
			// refresh action
			Intent iMyOrder = new Intent(CategoryListActivity.this, CartActivity.class);
    ...
    public class getDataTask extends AsyncTask<Void, Void, Void>{
		...
		protected void onPostExecute(Void result) {
			...
			if((Category_name.size() > 0) && (IOConnect == 0)){
    ...
    public void parseJSONData(){
    	...
    	try {
			...
			JSONArray data = json.getJSONArray("brands");
